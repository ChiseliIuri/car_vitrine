<div class="container">
    ...
    <form class="inputsForm" id="settingsForm" method="post" action="/" enctype="multipart/form-data">
        ...
        <div style="margin-top: 20px; width:100%; display: flex; flex-direction:column; justify-content:center; align-items: center;">
            <button type="submit" class="button add_new_project">Save settings</button>
        </div>
    </form>
